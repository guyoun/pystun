...
def stun_test(sock, host, port, source_ip, source_port, send_data=""):
    ...
    while not recvCorr:
        ...
        trainid_res = binascii.b2a_hex(buf[4:20]).decode('utf-8')
        tranid_match = tranid.upper() == trainid_res.upper()
...
def get_ip_info(source_ip="0.0.0.0", source_port=None,
                stun_host=None, stun_port=None):
    stun_port = stun_port or DEFAULTS['stun_port']
    source_port = source_port or DEFAULTS['source_port']
